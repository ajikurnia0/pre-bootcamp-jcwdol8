...
import {
  ...
  submitProfileDataEdit,
} from "../utils/axios/profileAPIs";
      ...
      <div className="mx-auto h-screen w-2/3">
        <div className="border bg-white h-2/3 my-12 flex">
          <div className="text-center w-1/4">
            <h1
              className="hover:border-l-2 hover:border-gray-700 hover:font-semibold hover:bg-gray-50 py-2"
              onClick={() => setMenuTab("editprofile")}
            >
              Edit Profile
            </h1>
            <h1
              className="hover:border-l-2 hover:border-gray-700 hover:font-semibold hover:bg-gray-50 py-2"
              onClick={() => setMenuTab("editProfilePicture")}
            >
          ...
          <div className="border-l w-full relative">
            {menuTab === "editprofile" ? (
              <>
                <div className="grid grid-cols-4 pt-6 w-full px-8 gap-4">
                  ...
                  <div className="col-span-3">
                    ...
                    <h2 className="text-xs text-gray-500">
                      ...
                      know by: either your full name, nickname, or business
                      name.
                    </h2>
                  </div>
                </div>
                <div className="grid grid-cols-4 pt-6 px-8 w-full">
                  ...
                  <div className="col-span-3">
                    ...
                    <h2 className="text-xs text-gray-500">
                      ...
                      within 14 days. Since this is a clone project, this
                      statement is false.
                    </h2>
                  </div>
                </div>
                ...
                <button
                  type="button"
                  className="absolute bottom-16 right-1/2 font-semibold text-white py-1 hover:bg-blue-500 bg-blue-400 rounded-md px-4"
                  onClick={() =>
                    submitProfileDataEdit(
                  ...
                  <div className="grid grid-cols-4 pt-6 w-full px-8 gap-4">
                    ...
                    <div className="col-span-3">
                      <input
                        ...
                        onChange={handleChange}
                      />
                      <h2 className="text-xs text-gray-500">CEK</h2>
                    </div>
                  </div>
                  <div className="grid grid-cols-4 pt-6 px-8 w-full">
                    <h1 className="font-semibold col-span-1">Username</h1>
                    <div className="col-span-3">
                      ...
                      <h2 className="text-xs text-gray-500">
                        ...
                        back within 14 days. Since this is a clone project, this
                        statement is false.
                      </h2>
                    </div>
                  </div>
